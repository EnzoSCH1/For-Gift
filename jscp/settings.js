...
let settings = {
    ...
    pages: [
        ...
        { image: './image/photos/b1.webp' },
        { image: './image/photos/b2.webp' },
        { image: './image/photos/b3.webp' },
        { image: './image/photos/b4.webp' },
        { image: './image/photos/b5.webp' },
        { image: './image/photos/b6.webp' },
        { image: './image/theend.jpg' }
    ],
    enableBook: true,
    enableHeart: true,
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            // Page photo 1
            { image: './image/photos/b1.webp' },
            // Page photo 2 (avec texte)
            { image: './image/photos/b2.webp', content: "Je t'aime mon Alizée ❤️" },
            // Page photo 3 
            { image: './image/photos/b3.webp' },
            // Page photo 4
            { image: './image/photos/b4.webp', content: "Celle que j'aime le plus, avec qui je partage tout" },
            // Page photo 5
            { image: './image/photos/b5.webp' },
            // Page photo 6
            { image: './image/photos/b6.webp', content: "j'éspére que tu sera heureuse toute ta vie avec moi ! Moi c'est le cas ! ❤️" },
            // Fin
            { image: './image/theend.jpg' }
        ]
    };
    // Images spécifiques pour l'effet coeur (mosaïque)
    window.heartImages = [
        './image/photos/b7.webp',
        './image/photos/b8.webp',
        './image/photos/b9.webp',
        './image/photos/b10.webp',
        './image/photos/b11.webp',
        './image/photos/b12.webp',
        './image/photos/b13.webp',
        './image/photos/b14.webp',
        './image/photos/b15.webp',
        './image/photos/b16.webp',
        './image/photos/b17.jpeg',
        './image/photos/b18.webp',
        './image/photos/b19.webp',
    ];
